...
public class statsManager : MonoBehaviour
{
	...
	void Start ()
	{
        ...
        Button refreshButton = refresh.gameObject.GetComponent<Button>();
        refreshButton.onClick.AddListener(refreshPlanet);
    ...
    void refreshPlanet()
    {
        if (planetLevel >= 25)
        {
            MeshRenderer stage1Mesh = stage1.GetComponent<MeshRenderer>();
            stage1Mesh.enabled = false;
            MeshRenderer stage2Mesh = stage2.GetComponent<MeshRenderer>();
            stage2Mesh.enabled = false;
            MeshRenderer stage3Mesh = finalStage.GetComponent<MeshRenderer>();
            stage3Mesh.enabled = false;
